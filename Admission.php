  ...
  <p id="bg-text1" class="bgadm1">Selection</p>
   ...
   <div class="col-md-5 col-xs-12 selectpos1 " style="">
    ...
    <div id="01" class="panel-collapse collapse">
      ...
      <div class="panel-body">
      <p class="admission-para" style=""> It is an examination which covers 
      <ul><li><span>Management aptitude</span></li><li><span>Reasoning skills</span></li><li><span>English</span></li><li><span>Mathematics.</span></li></ul> 
       </p>
      </div>
    ...
    <div id="2" class="panel-collapse collapse">
      <div class="panel-body">
        <p class="admission-span-para" style="">
        <ul><li><span>Any aspiring student of MBA who would like to take up their education at ISSM can take up the test.
        </span>  </li>
           <li><span>It is also considered as an alternative exam for CAT,MAT, TANCET to take an MBA admission only at ISSM
           </span></li>
           <li><span>
              
An applicant who possesses CAT, MAT, or TANCET score can also apply for TRE to avail more percentage of scholarship to pursue his/her MBA at ISSM.</span></li>

          </ul><br>Note: ISSM uses the CAT/XAT/MAT score for short-listing candidates called for Group Discussions/Personal Interview. IIM's have no role in selection or in conducting the program.
